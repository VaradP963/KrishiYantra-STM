...
#ifndef _ApplicationCottonScreen_H
#define _ApplicationCottonScreen_H
...
/* Forward declaration of the class Application::CottonScreen */
#ifndef _ApplicationCottonScreen_
  EW_DECLARE_CLASS( ApplicationCottonScreen )
#define _ApplicationCottonScreen_
#endif
...
/* Deklaration of class : 'Application::CottonScreen' */
EW_DEFINE_FIELDS( ApplicationCottonScreen, ApplicationBaseScreen )
...
EW_END_OF_FIELDS( ApplicationCottonScreen )

/* Virtual Method Table (VMT) for the class : 'Application::CottonScreen' */
EW_DEFINE_METHODS( ApplicationCottonScreen, ApplicationBaseScreen )
...
EW_END_OF_METHODS( ApplicationCottonScreen )
...
#endif /* _ApplicationCottonScreen_H */
