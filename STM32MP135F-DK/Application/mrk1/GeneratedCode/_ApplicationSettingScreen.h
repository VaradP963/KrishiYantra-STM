...
#ifndef _ApplicationSettingScreen_H
#define _ApplicationSettingScreen_H
...
/* Forward declaration of the class Application::SettingScreen */
#ifndef _ApplicationSettingScreen_
  EW_DECLARE_CLASS( ApplicationSettingScreen )
#define _ApplicationSettingScreen_
#endif
...
/* Deklaration of class : 'Application::SettingScreen' */
EW_DEFINE_FIELDS( ApplicationSettingScreen, ApplicationBaseScreen )
  ...
  EW_OBJECT  ( ToggleButtonConfig, WidgetSetToggleButtonConfig )
  EW_OBJECT  ( SimpleTouchHandler1, CoreSimpleTouchHandler )
  EW_OBJECT  ( Text3,           ViewsText )
  EW_OBJECT  ( Text4,           ViewsText )
  EW_OBJECT  ( Wifi,            ViewsText )
  EW_OBJECT  ( Wifi1,           ViewsText )
  EW_OBJECT  ( Wifi2,           ViewsText )
...
EW_END_OF_FIELDS( ApplicationSettingScreen )

/* Virtual Method Table (VMT) for the class : 'Application::SettingScreen' */
EW_DEFINE_METHODS( ApplicationSettingScreen, ApplicationBaseScreen )
...
EW_END_OF_METHODS( ApplicationSettingScreen )
...
#endif /* _ApplicationSettingScreen_H */
