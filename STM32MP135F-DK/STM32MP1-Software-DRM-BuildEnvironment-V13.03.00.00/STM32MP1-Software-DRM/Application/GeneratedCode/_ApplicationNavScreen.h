...
#ifndef _ApplicationNavScreen_H
#define _ApplicationNavScreen_H
...
/* Forward declaration of the class Application::NavScreen */
#ifndef _ApplicationNavScreen_
  EW_DECLARE_CLASS( ApplicationNavScreen )
#define _ApplicationNavScreen_
#endif
...
/* Deklaration of class : 'Application::NavScreen' */
EW_DEFINE_FIELDS( ApplicationNavScreen, ApplicationBaseScreen )
  ...
  EW_OBJECT  ( PushButtonConfig2, WidgetSetPushButtonConfig )
  EW_OBJECT  ( PushButtonConfig3, WidgetSetPushButtonConfig )
EW_END_OF_FIELDS( ApplicationNavScreen )

/* Virtual Method Table (VMT) for the class : 'Application::NavScreen' */
EW_DEFINE_METHODS( ApplicationNavScreen, ApplicationBaseScreen )
...
EW_END_OF_METHODS( ApplicationNavScreen )
