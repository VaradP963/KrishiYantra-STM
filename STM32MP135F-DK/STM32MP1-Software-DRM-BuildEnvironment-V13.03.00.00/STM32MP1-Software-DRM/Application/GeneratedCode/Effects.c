...
/* Initializer for the class 'Effects::WarpFader' */
void EffectsWarpFader__Init( EffectsWarpFader _this, XObject aLink, XHandle aArg )
{
  /* At first initialize the super class ... */
  EffectsFader__Init( &_this->_.Super, aLink, aArg );

  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_.XObject._.GCT = EW_CLASS_GCT( EffectsWarpFader );

  /* ... then construct all embedded objects */
  EffectsInt32Effect__Init( &_this->OpacityEffect, &_this->_.XObject, 0 );
  EffectsFloatEffect__Init( &_this->WarpEffect, &_this->_.XObject, 0 );
  GraphicsWarpMatrix__Init( &_this->Matrix, &_this->_.XObject, 0 );
  GraphicsWarpMatrix__Init( &_this->current, &_this->_.XObject, 0 );

  /* Setup the VMT pointer */
  _this->_.VMT = EW_CLASS( EffectsWarpFader );
}

/* Re-Initializer for the class 'Effects::WarpFader' */
void EffectsWarpFader__ReInit( EffectsWarpFader _this )
{
  /* At first re-initialize the super class ... */
  EffectsFader__ReInit( &_this->_.Super );
  ...
  /* ... then re-construct all embedded objects */
  EffectsInt32Effect__ReInit( &_this->OpacityEffect );
  EffectsFloatEffect__ReInit( &_this->WarpEffect );
  GraphicsWarpMatrix__ReInit( &_this->Matrix );
  GraphicsWarpMatrix__ReInit( &_this->current );
}

/* Finalizer method for the class 'Effects::WarpFader' */
void EffectsWarpFader__Done( EffectsWarpFader _this )
{
  /* Finalize this class */
  _this->_.Super._.VMT = EW_CLASS( EffectsFader );
  ...
  /* Finalize all embedded objects */
  EffectsInt32Effect__Done( &_this->OpacityEffect );
  EffectsFloatEffect__Done( &_this->WarpEffect );
  GraphicsWarpMatrix__Done( &_this->Matrix );
  GraphicsWarpMatrix__Done( &_this->current );
...
void EffectsWarpFader_OnEnd( EffectsWarpFader _this )
{
  ...
  {
    CoreGroup__OnSetOpacity( _this->Super1.Group, _this->OpacityEffect.Value2 );
    CoreRectView__OnSetBounds( _this->Super1.Group, EwMoveRectPos( EwMoveRectNeg( 
    _this->Super1.Group->Super1.Bounds, EwGetRectCenter( _this->Super1.Group->Super1.Bounds )), 
    _this->Position2 ));
    CoreGroup_OnSetVisible( _this->Super1.Group, 1 );
  }

  if ( !_this->Super1.Visible && ( _this->OpacityEffect.Value2 == 0 ))
  {
    CoreGroup__OnSetOpacity( _this->Super1.Group, 0 );
    CoreGroup_OnSetVisible( _this->Super1.Group, 0 );
  }

  if ((( !_this->Super1.Visible && ( _this->OpacityEffect.Value2 > 0 )) && ( _this->Super1.Group->Super2.Owner 
      != 0 )) && !_this->Super1.RemoveIfHidden )
  {
    CoreGroup__OnSetOpacity( _this->Super1.Group, _this->OpacityEffect.Value2 );
    CoreRectView__OnSetBounds( _this->Super1.Group, EwMoveRectPos( EwMoveRectNeg( 
    _this->Super1.Group->Super1.Bounds, EwGetRectCenter( _this->Super1.Group->Super1.Bounds )), 
  ...
  if ( _this->warpView != 0 )
    CoreGroup_Remove( _this->Super1.Owner, ((CoreView)_this->warpView ));
...
void EffectsWarpFader_OnStart( EffectsWarpFader _this )
{
  ...
  if ( _this->Super1.UseCurrentState )
  {
    ...
    _this->Position1 = EwGetRectCenter( _this->Super1.Group->Super1.Bounds );
  }
  ...
  == 0 ) || !CoreGroup_OnGetVisible( _this->Super1.Group )) || _this->Super1.RemoveIfHidden )) 
  || ( _this->OpacityEffect.Value2 == 0 )) || EwIsRectEmpty( EwIntersectRect( EwMoveRectPos( 
  EwMoveRectNeg( _this->Super1.Group->Super1.Bounds, EwGetRectCenter( _this->Super1.Group->Super1.Bounds )), 
  _this->Position2 ), EwGetRectORect( _this->Super1.Owner->Super1.Bounds ))));

  if ( isHidden && isHidden2 )
  {
    _this->OpacityEffect.Value1 = 0;
    _this->OpacityEffect.Value2 = 0;
    _this->Position1 = _this->Position2;
    GraphicsWarpMatrix_LoadIdentity( &_this->Matrix );
  }
  ...
  if (( !_this->Super1.Visible && !EwCompPoint( _this->Position1, _this->Position2 )) 
      && GraphicsWarpMatrix_IsIdentity( &_this->Matrix ))
    CoreRectView__OnSetBounds( _this->Super1.Group, EwMoveRectPos( EwMoveRectNeg( 
    _this->Super1.Group->Super1.Bounds, EwGetRectCenter( _this->Super1.Group->Super1.Bounds )), 
    _this->Position1 ));
  ...
  if ((( _this->Super1.Visible && ( _this->Super1.Group->Opacity == _this->OpacityEffect.Value2 )) 
      && !EwCompPoint( EwGetRectCenter( _this->Super1.Group->Super1.Bounds ), _this->Position2 )) 
      && CoreGroup_OnGetVisible( _this->Super1.Group ))
  {
    _this->finished = 1;
    EffectsFader_Complete((EffectsFader)_this );
    return;
  ...
  if ((( _this->OpacityEffect.Value1 == _this->OpacityEffect.Value2 ) && !EwCompPoint( 
      _this->Position1, _this->Position2 )) && GraphicsWarpMatrix_IsIdentity( &_this->Matrix ))
  {
    _this->finished = 1;
    EffectsFader_Complete((EffectsFader)_this );
    return;
  ...
  CoreGroup_OnSetVisible( _this->Super1.Group, 0 );
  _this->warpView = EwNewObject( ViewsWarpGroup, 0 );
  ViewsWarpGroup_OnSetGroup( _this->warpView, _this->Super1.Group );
  ViewsWarpGroup_OnSetOpacity( _this->warpView, _this->OpacityEffect.Value1 );
  ViewsWarpView_OnSetSourceAnchor((ViewsWarpView)_this->warpView, EwGetRectCenter( 
  EwGetRectORect( _this->Super1.Group->Super1.Bounds )));
  CoreGroup_AddBehind( _this->Super1.Group->Super2.Owner, ((CoreView)_this->warpView ), 
  ((CoreView)_this->Super1.Group ));

  if ( _this->OpacityEffect.Super1.NoOfCycles == 0 )
    EffectsEffect_OnSetNoOfCycles((EffectsEffect)&_this->OpacityEffect, 1 );

  if ( _this->WarpEffect.Super1.NoOfCycles == 0 )
    EffectsEffect_OnSetNoOfCycles((EffectsEffect)&_this->WarpEffect, 1 );

  EffectsEffect_OnSetReversed((EffectsEffect)&_this->WarpEffect, 0 );
  _this->WarpEffect.Super1.OnFinished = EwNewSlot( _this, EffectsWarpFader_onFinished );
  _this->WarpEffect.Super1.OnAnimate = EwNewSlot( _this, EffectsWarpFader_onAnimate );

  if ( _this->Super1.Visible )
  {
    _this->WarpEffect.Value1 = 0.0f;
    _this->WarpEffect.Value2 = 1.0f;
  }
  else
  {
    _this->WarpEffect.Value1 = 1.0f;
    _this->WarpEffect.Value2 = 0.0f;
  }

  _this->OpacityEffect.Outlet = EwNewRef( _this->warpView, ViewsWarpGroup_OnGetOpacity, 
  ViewsWarpGroup_OnSetOpacity );
  EffectsEffect_OnSetReversed((EffectsEffect)&_this->OpacityEffect, 0 );
  _this->OpacityEffect.Super1.OnFinished = EwNewSlot( _this, EffectsWarpFader_onFinished );
  _this->OpacityEffect.Super1.OnAnimate = EwNullSlot;
  EffectsEffect_OnSetEnabled((EffectsEffect)&_this->WarpEffect, (XBool)( EwCompPoint( 
  _this->Position1, _this->Position2 ) || !GraphicsWarpMatrix_IsIdentity( &_this->Matrix )));
  EffectsEffect_OnSetEnabled((EffectsEffect)&_this->OpacityEffect, (XBool)( _this->OpacityEffect.Value1 
  != _this->OpacityEffect.Value2 ));
}
...
void EffectsWarpFader_onFinished( EffectsWarpFader _this, XObject sender )
{
  ...
  _this->finished = (XBool)( !_this->OpacityEffect.Super1.Enabled && !_this->WarpEffect.Super1.Enabled );
  EffectsFader_Complete((EffectsFader)_this );
}
...
void EffectsWarpFader_onAnimate( EffectsWarpFader _this, XObject sender )
{
  ...
  translation = EwMovePointNeg( _this->Position2, _this->Position1 );

  if ( !_this->Super1.Visible )
    translation = EwNegPoint( translation );

  GraphicsWarpMatrix_LoadIdentity( &_this->current );
  _this->current.EyeDistance = _this->Matrix.EyeDistance;
  GraphicsWarpMatrix_Translate( &_this->current, (XFloat)translation.X, (XFloat)translation.Y, 
  0.0f );
  GraphicsWarpMatrix_Interpolate( &_this->current, &_this->Matrix, &_this->current, 
  _this->WarpEffect.Value );

  if ( _this->Super1.Visible )
    ViewsWarpView_Warp3D((ViewsWarpView)_this->warpView, _this->Position1, &_this->current );
  else
    ViewsWarpView_Warp3D((ViewsWarpView)_this->warpView, _this->Position2, &_this->current );
}

/* Variants derived from the class : 'Effects::WarpFader' */
EW_DEFINE_CLASS_VARIANTS( EffectsWarpFader )
EW_END_OF_CLASS_VARIANTS( EffectsWarpFader )

/* Virtual Method Table (VMT) for the class : 'Effects::WarpFader' */
EW_DEFINE_CLASS( EffectsWarpFader, EffectsFader, OpacityEffect, warpView, Position2, 
                 Position2, Position2, Position2, "Effects::WarpFader" )
  EffectsWarpFader_IsFinished,
  EffectsWarpFader_OnEnd,
  EffectsWarpFader_OnStart,
EW_END_OF_CLASS( EffectsWarpFader )
...
/* Initializer for the class 'Effects::ScaleTransition' */
void EffectsScaleTransition__Init( EffectsScaleTransition _this, XObject aLink, XHandle aArg )
{
  /* At first initialize the super class ... */
  EffectsTransition__Init( &_this->_.Super, aLink, aArg );

  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_.XObject._.GCT = EW_CLASS_GCT( EffectsScaleTransition );

  /* Setup the VMT pointer */
  _this->_.VMT = EW_CLASS( EffectsScaleTransition );

  /* ... and initialize objects, variables, properties, etc. */
  _this->Alignment = EffectsDialogAlignmentAlignHorzCenter | EffectsDialogAlignmentAlignVertCenter;
}

/* Re-Initializer for the class 'Effects::ScaleTransition' */
void EffectsScaleTransition__ReInit( EffectsScaleTransition _this )
{
  /* At first re-initialize the super class ... */
  EffectsTransition__ReInit( &_this->_.Super );
}

/* Finalizer method for the class 'Effects::ScaleTransition' */
void EffectsScaleTransition__Done( EffectsScaleTransition _this )
{
  /* Finalize this class */
  _this->_.Super._.VMT = EW_CLASS( EffectsTransition );
...
{
  EffectsWarpFader fader = EwNewObject( EffectsWarpFader, 0 );
  ...
  fader->Super1.RestackTopmost = 1;
  fader->Super1.UseCurrentState = 1;
  fader->Super1.OnInitialize = EwNewSlot( _this, EffectsScaleTransition_onInitializeIn );
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->OpacityEffect, 500 );
  EffectsEffect_OnSetInitialDelay((EffectsEffect)&fader->OpacityEffect, 0 );
  fader->OpacityEffect.Value1 = 0;
  fader->OpacityEffect.Value2 = 255;
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->WarpEffect, 500 );
  EffectsEffect_OnSetTiming((EffectsEffect)&fader->WarpEffect, EffectsTimingFastIn_EaseOut );
  EffectsEffect_OnSetTimingCustom1((EffectsEffect)&fader->WarpEffect, 0.0f );
  EffectsEffect_OnSetTimingCustom2((EffectsEffect)&fader->WarpEffect, 0.0f );
  EffectsEffect_OnSetExponent((EffectsEffect)&fader->WarpEffect, 3.0f );
  EffectsEffect_OnSetAmplitude((EffectsEffect)&fader->WarpEffect, 0.5f );
  EffectsEffect_OnSetOscillations((EffectsEffect)&fader->WarpEffect, 3 );
  EffectsEffect_OnSetBounces((EffectsEffect)&fader->WarpEffect, 3 );
  EffectsEffect_OnSetElasticity((EffectsEffect)&fader->WarpEffect, 0.5f );
  GraphicsWarpMatrix_Scale( &fader->Matrix, 0.5f, 0.5f, 1.0f );
  return ((EffectsFader)fader );
}
...
EffectsFader EffectsScaleTransition_CreateDismissFader( EffectsScaleTransition _this )
{
  ...
  fader->Super1.RemoveIfHidden = 1;
  fader->Super1.UseCurrentState = 1;
  fader->Super1.OnInitialize = EwNewSlot( _this, EffectsScaleTransition_onInitializeOut );
  fader->OpacityEffect.Value1 = 255;
  fader->OpacityEffect.Value2 = 0;
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->OpacityEffect, 500 );
  EffectsEffect_OnSetInitialDelay((EffectsEffect)&fader->OpacityEffect, 0 );
...
void EffectsScaleTransition_onInitializeIn( EffectsScaleTransition _this, XObject 
  sender )
{
  EffectsWarpFader fader = EwCastObject( sender, EffectsWarpFader );
  ...
  fader->Position2 = EwMovePointPos( pos, EwNewPoint( size.X / 2, size.Y / 2 ));

  if (((( fader->Super1.Group->Super2.Owner == 0 ) || !CoreGroup_OnGetVisible( fader->Super1.Group )) 
      || ( fader->Super1.Group->Opacity == 0 )) || EwIsRectEmpty( EwIntersectRect( 
      fader->Super1.Group->Super1.Bounds, EwGetRectORect( fader->Super1.Owner->Super1.Bounds ))))
    CoreRectView__OnSetBounds( fader->Super1.Group, EwSetRectOrigin( fader->Super1.Group->Super1.Bounds, 
    EwMovePointNeg( fader->Position2, EwGetRectCenter( EwGetRectORect( fader->Super1.Group->Super1.Bounds )))));
}
...
void EffectsScaleTransition_onInitializeOut( EffectsScaleTransition _this, XObject 
  sender )
{
  EffectsWarpFader fader;

  /* Dummy expressions to avoid the 'C' warning 'unused argument'. */
  EW_UNUSED_ARG( _this );

  fader = EwCastObject( sender, EffectsWarpFader );
  fader->Position2 = EwGetRectCenter( fader->Super1.Group->Super1.Bounds );
}

/* Variants derived from the class : 'Effects::ScaleTransition' */
EW_DEFINE_CLASS_VARIANTS( EffectsScaleTransition )
EW_END_OF_CLASS_VARIANTS( EffectsScaleTransition )

/* Virtual Method Table (VMT) for the class : 'Effects::ScaleTransition' */
EW_DEFINE_CLASS( EffectsScaleTransition, EffectsTransition, _.VMT, _.VMT, _.VMT, 
                 _.VMT, _.VMT, _.VMT, "Effects::ScaleTransition" )
  EffectsScaleTransition_CreatePresentFader,
  EffectsScaleTransition_CreateDismissFader,
  EffectsScaleTransition_CreateRestoreFader,
  EffectsScaleTransition_CreateOverlayFader,
EW_END_OF_CLASS( EffectsScaleTransition )
